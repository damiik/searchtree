...
class SearchItem extends Component {
  ...
  render() {
    ...
    return (
      ...
      <button type="button" className={"btn btn-md btn-success glyphicon " + (this.props.todo.completed ? "glyphicon-asterisk" : "glyphicon-pushpin")} onClick={this.handlePushpin.bind(this)}/>  <button type="button" className="btn btn-md btn-danger" onClick={this.handleDelete.bind(this)}><span class="glyphicon glyphicon-remove"></span></button>
      </a>
    )
  }
}
