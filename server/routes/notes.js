...
router.put('/', function (req, res, next) {
  console.log('put:' + req.body._id + ', update:' + JSON.stringify(req.body.updateObject, null, 2)); //Note.findByIdAndUpdate(req.body._id, {note:req.body.text}, function (err, post) {
